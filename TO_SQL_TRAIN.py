...
# Create the database
cur.execute("CREATE DATABASE IF NOT EXISTS PokerTrain")

# Use the new database
cur.execute("USE PokerTrain")
...
cur.execute(f"""
LOAD DATA INFILE '/var/lib/mysql-files/poker-hand-training.csv' INTO TABLE poker_hands FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 LINES
""")
